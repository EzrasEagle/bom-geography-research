...
export const LAYOUT_INTERNAL: Record<string, Point> = {
  ...
  sidon: { x: 310, y: 195 },
  amnihu: { x: 348, y: 168 },
  "zarahemla-land": { x: 275, y: 190 },
  zarahemla: { x: 265, y: 155 },
  "city-nephi": { x: 185, y: 295 },
  "east-sea-cluster": { x: 410, y: 140 },
  jershon: { x: 400, y: 180 },
  ...
  ammonihah: { x: 200, y: 140 },
  gideon: { x: 340, y: 148 },
  melek: { x: 220, y: 175 },
  minon: { x: 300, y: 248 },
  antionum: { x: 360, y: 180 },
  morianton: { x: 400, y: 120 },
  "lehi-city": { x: 420, y: 130 },
  mulek: { x: 380, y: 100 },
  joshua: { x: 100, y: 80 },
  helam: { x: 200, y: 250 },
  shemlon: { x: 160, y: 310 },
...
export const MODEL_DEFAULT_LAYOUTS: Record<string, Record<string, Point>> = {
  ...
  mesoamerica: {
    ...
    gideon: { x: 300, y: 155 },
    melek: { x: 200, y: 165 },
    ammonihah: { x: 180, y: 130 },
    minon: { x: 240, y: 200 },
    antionum: { x: 360, y: 170 },
    jershon: { x: 400, y: 145 },
    "lehi-city": { x: 420, y: 120 },
    morianton: { x: 400, y: 110 },
    mulek: { x: 380, y: 95 },
    "bountiful-nw": { x: 320, y: 100 },
    "narrow-neck": { x: 300, y: 85 },
    desolation: { x: 300, y: 55 },
    cumorah: { x: 360, y: 40 },
    joshua: { x: 120, y: 70 },
    wilderness: { x: 210, y: 230 },
    "climate-whirlwind": { x: 440, y: 280 },
    "climate-storms": { x: 460, y: 250 },
    "climate-seasons": { x: 420, y: 300 },
    "climate-agriculture": { x: 400, y: 270 },
  },
  "meso-highland": {
    "sea-west": { x: 50, y: 210 },
