//#region node_modules/.nitro/vite/services/ssr/assets/catalog-CJAtBXtA.js
var models = [
	{
		id: "mesoamerica",
		...
		status: "active",
		summary: "Places events primarily in southern Mexico and Guatemala with a limited geography. Isthmus of Tehuantepec is a common narrow-neck candidate.",
		coreMap: {
		...
		strengths: [
			...
			"Isthmus geography",
			"Population scale debates favor urban societies"
		],
		criticisms: [
			"NY Cumorah tradition tension",
			"Directional conventions",
			"River correlations contested"
		]
	},
	{
		id: "heartland",
		...
		category: "heartland",
		status: "active",
		summary: "Locates primary lands in the central/eastern United States, often with the Mississippi as Sidon and New York Cumorah as the final battle region.",
		coreMap: {
		...
		criticisms: [
			"Urban complexity",
			"Seas and narrow neck fit",
			"Climate/crop timing debates"
		]
	},
	{
		id: "baja",
		...
		category: "baja",
		status: "active",
		summary: "Emphasizes Mediterranean/arid climate match for Jerusalem seeds, dual seas, and peninsular narrow geography on Baja California.",
		coreMap: {
		...
		strengths: [
			"Climate/seed argument",
			"Dual seas",
			"Wilderness motifs"
		],
		criticisms: [
			"Large-city descriptions",
			"Jaredite archaeology on Baja",
			"Major river Sidon"
		]
	},
	{
		...
		status: "historical",
		summary: "Family of models with Chilean landing (~30–33°S climate analogy) and Andean or hemispheric extensions.",
		coreMap: {
	...
	},
	{
		...
		category: "internal",
		status: "active",
		summary: "Relational map from the text alone—distances, directions, and place graph—without committing to modern coordinates.",
		coreMap: {
...
var verses = [
	{
		...
		verseStart: 5,
		verseEnd: 5,
		textExcerpt: "And we did come to the land which we called Bountiful, because of its much fruit and also wild honey; and all these things were prepared of the Lord that we might not perish...",
	...
	},
	{
		...
		verseStart: 23,
		verseEnd: 23,
		textExcerpt: "And it came to pass that after we had sailed for the space of many days we did arrive at the promised land; and we went forth upon the land, and did pitch our tents; and we did call it the promised land.",
		plateSource: "small_plates",
		speaker: "Nephi",
		tags: [
			"landing",
	...
	},
	{
		...
		verseStart: 24,
		verseEnd: 24,
		textExcerpt: "And it came to pass that we did begin to till the earth, and we began to plant seeds; yea, we did put all our seeds into the earth, which we had brought from the land of Jerusalem. And it came to pass that they did grow exceedingly; wherefore, we were blessed in abundance.",
		plateSource: "small_plates",
		speaker: "Nephi",
		tags: [
			"seed-grow",
...
var insights = [{
	...
	category: "travel",
	summary: "Natural-topography corridor analysis and 18th-century travel-time estimates for the Baja → Colorado Delta → Rio Grande → Gulf path.",
	confidence: "probable",
	relatedVerses: [],
	relevanceToModels: [
		"baja",
...
Realistic path length often 1,500–2,500+ miles. For 18th-century mounted parties under ideal cool-season conditions: about 4–5 months; pure foot typically longer. See research/insights/travel/baja-to-gulf-foot-route.md for sources.`
	...
	category: "flora",
	summary: "Where date palms, olives, grapes, figs and related Near Eastern crops cultivate successfully; relevance to 1 Nephi 18:24.",
...
function versesForModel(modelId) {
...
//#endregion
export { insights as a, verses as c, getVerse as i, versesForModel as l, getInsight as n, models as o, getModel as r, stats as s, frameworkSections as t };
